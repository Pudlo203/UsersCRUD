...
public class UserDao {
    private static final String CREATE_QUERY = "INSERT INTO users (name, password, email) VALUES (?, ?, ?)";
    private static final String FIND_QUERY = "SELECT * FROM users WHERE id=?";
    private static final String DELETE_QUERY = "DELETE FROM users WHERE id=?";
    private static final String UPDATE_QUERY = "UPDATE users SET name = ?, password = ?, email = ? WHERE id = ?";
